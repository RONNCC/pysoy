...
static char
tp_doc[] = "soy.widgets.Projector Type\n"
"\n"
...
tp_new (PyTypeObject* type, PyObject* args,
    ...
    static char* kw[] = {"parent", "camera", NULL};
    ...
    // new gobject
    self->g = soy_widgets_projector_new(parent->g, camera->g);
...
static PyObject*
tp_repr (SELF self) {
    return PyUnicode_FromFormat("<Camera>");
}
...
static char
camera_doc[] = {"Camera object or none"};


PYSOY_PROP_OBJECT(widgets, widget, size, atoms_Size)
static char
size_doc[] = {"Projector size"};
