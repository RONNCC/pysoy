...
static char
tp_doc[] = "soy.atoms.Vertex Type\n"
"\n"
"    This type stores the vertex of an object.\n"
"\n"
"    Vertex is stored as a position Position, a normal Vector,"
"    a texture coordinate Position and a tangent Vector."
"\n";
...
static char
position_doc[] = "soy.atoms.Position";
PYSOY_PROP_OBJECT_OWNED(atoms, vertex, position, atoms_Position)


static char
normal_doc[] = "soy.atoms.Vector\n"
"\n"
"    This is the vertex's normal vector\n"
"\n";
PYSOY_PROP_OBJECT_OWNED(atoms, vertex, normal, atoms_Vector)


static char
texcoord_doc[] = "soy.atoms.Position\n"
"\n"
"    The vertex's texcoord\n"
"\n";
PYSOY_PROP_OBJECT_OWNED(atoms, vertex, texcoord, atoms_Position)


static char
tangent_doc[] = "soy.atoms.Vector\n"
"\n"
"    This is the vertex's tangent vector\n"
"\n";
