...
"\n"
"    If window.size returned a plain list changing one of its items would\n"
"    not resize the window by itself, you would instead have to::\n"
"\n"
"        >>> w = soy.widgets.Window()\n"
"        >>> w.size = soy.atoms.Size((w.size[0] + 80, w.size[1], 0))\n"
"        >>> w.size\n"
"        <Size (400.000000, 240.000000, 0.000000)>\n"
"\n"
...
static char
width_doc[] = "Length along X axis";
PYSOY_PROP_FLOAT(atoms, size, width)


static char
height_doc[] = "Length along Y axis";
PYSOY_PROP_FLOAT(atoms, size, height)


static char
depth_doc[] = "Size on Z axis";
