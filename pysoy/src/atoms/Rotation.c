...
static char
tp_doc[] = "soy.atoms.Rotation Type\n"
"\n"
"    This type stores the rotation of an object as three floats (alpha, beta, gamma).\n"
"\n"
...
nb_inplace_add (PyObject* this, PyObject* o2) {
    ...
    soy_atoms_rotation_set_alpha(self->g, soy_atoms_rotation_get_alpha(self->g) + o2x);
    soy_atoms_rotation_set_beta(self->g, soy_atoms_rotation_get_beta(self->g) + o2y);
    soy_atoms_rotation_set_gamma(self->g, soy_atoms_rotation_get_gamma(self->g) + o2z);
...
static char
alpha_doc[] = "Rotation Around X Axis";
PYSOY_PROP_FLOAT(atoms, rotation, alpha)


static char
beta_doc[] = "Rotation around Y Axis";
PYSOY_PROP_FLOAT(atoms, rotation, beta)


static char
gamma_doc[] = "Rotation on Z dimension";
