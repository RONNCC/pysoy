...
static char
tp_doc[] = "soy.atoms.Morph Type\n"
"\n"
"   This atom represents the difference between one mesh (seed) and a different mesh with the same number of faces (variant).\n"
"\n"
"   The resultant matrix is multiplied by delta (a value between 0.0 and 1.0) and can be added to a soy.models.Target.\n"
"\n"
