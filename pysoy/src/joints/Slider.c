...
static char
tp_doc[] = "soy.joints.Slider Type\n"
"\n"
"   :class:`~soy.joints.Slider` joints restrict movement of 2 bodies or a\n"
"   body and its scene to a straight line that goes through the center of\n"
"   the objects and an axis\n"
"\n"
"   Example:\n"
"       >>> s = soy.scenes.Scene()\n"
"       >>> b = soy.bodies.Body(s)\n"
...
tp_new(PyTypeObject* type, PyObject* args, PyObject* kwds) {
    ...
    if(!bodyTwo)
        self->g = soy_joints_slider_new(scene, bodyOne->g, NULL, axis->g, NULL);
    else
        self->g = soy_joints_slider_new(scene, bodyOne->g, bodyTwo->g, axis->g, NULL);
