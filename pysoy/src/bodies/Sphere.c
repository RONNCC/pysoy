...
static char
tp_doc[] = "soy.bodies.Sphere Type\n"
"\n"
"Sphere is a sphere shaped body.\n"
"\n"
"Sphere has radius property for sphere radius,\n"
"subdivisions property for subdivisions for rendering,\n"
...
static char
material_doc[] = "Material to render Sphere with.";
PYSOY_PROP_OBJECT(bodies, sphere, material, materials_Material);


static char
radius_doc[] = "Sphere Radius";
PYSOY_PROP_FLOAT(bodies, sphere, radius);

static char
subdivisions_doc[] = "Sphere subdivisions";
PYSOY_PROP_UCHAR(bodies, sphere, subdivisions);
