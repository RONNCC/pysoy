...
tp_new (PyTypeObject* type, PyObject* args, PyObject* kwds) {
    ...
    // new gobject
    self->g = soy_bodies_camera_new(position);
...
static char
lens_doc[] = "Camera Lens\n"
"\n"
"    This is the (vertical) angle which the lens can view.  Defaults to 45.0\n"
"\n";
