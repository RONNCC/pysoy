...
// I am so, so sorry for this.  Please forgive me.  ~ Arc 2011-03-05
#define dcontact_geom_array_new(I) g_newa(dContactGeom, I)
#define dcontact_geom_array_get(O,I,N) *N = O[I]
