...
typedef struct {
    ...
    dReal y;
    dReal z;
    dReal _w;                                               // Placeholder
} dxVector3;
#define dvector3_new() g_new0(dxVector3, 1)
#define dvector3_free(this) g_free(this)
typedef dxVector3 *dVector3;
...
#define dvector4_new() g_new0(dxVector4, 1)
#define dvector4_free(this) g_free(this)
typedef dxVector4 *dVector4;
...
#define dmatrix3_new() g_new0(dxMatrix3, 1)
#define dmatrix3_free(this) g_free(this)
typedef dxMatrix3 *dMatrix3;
...
#define dquaternion_new() g_new0(dxQuaternion, 1)
#define dquaternion_free(this) g_free(this)
typedef dxQuaternion *dQuaternion;
