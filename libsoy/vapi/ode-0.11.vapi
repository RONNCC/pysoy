...
namespace ode {
    ...
    public class Body {
        ...
        public void          SetMass             (ref unowned Mass mass);
        public void          GetMass             (out unowned Mass mass);
    ...
    namespace geoms {
        ...
        public class HeightfieldData {
            ...
            public void BuildByte      (ref uchar* pHeightData,
                                        int bCopyHeightData,
                                        Real width, Real depth,
                                        int widthSamples, int depthSamples,
                                        Real scale, Real offset,
                                        Real thickness, int bWrap);
            public void BuildShort     (ref short* pHeightData,
                                        int bCopyHeightData,
                                        Real width, Real depth,
                                        int widthSamples, int depthSamples,
                                        Real scale, Real offset,
                                        Real thickness, int bWrap);
            public void BuildSingle    (ref float* pHeightData,
                                        int bCopyHeightData,
                                        Real width, Real depth,
                                        int widthSamples, int depthSamples,
                                        Real scale, Real offset,
                                        Real thickness, int bWrap);
            public void BuildDouble    (ref double* pHeightData,
                                        int bCopyHeightData,
                                        Real width, Real depth,
                                        int widthSamples, int depthSamples,
                                        Real scale, Real offset,
    ...
    [CCode (cname="struct dMass", cprefix="dMass",
