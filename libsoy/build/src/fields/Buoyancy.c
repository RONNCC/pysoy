/* Buoyancy.c generated by valac 0.18.1, the Vala compiler
...
static gboolean soy_fields_buoyancy_real_exert (soyfieldsField* base, soybodiesBody* other) {
	...
	_tmp26_ = _tmp25_;
	_tmp27_ = other;
	_tmp28_ = soy_bodies_body_get_mass (_tmp27_);
	_tmp29_ = _tmp28_;
	_tmp30_ = soy_mass_get_mass (_tmp29_);
	_tmp31_ = _tmp30_;
	_tmp32_ = submersion;
	_tmp33_ = other;
	_tmp34_ = soy_bodies_body_volume (_tmp33_);
	_tmp35_ = soy_fields_buoyancy_get_density (self);
	_tmp36_ = _tmp35_;
	_tmp37_ = _tmp31_ - ((_tmp32_ * _tmp34_) * _tmp36_);
	gee_abstract_map_set ((GeeAbstractMap*) _tmp26_, "bmass", &_tmp37_);
	_g_object_unref0 (_tmp26_);
	_tmp38_ = self->priv->_affected;
	_tmp39_ = other;
...
static GObject * soy_fields_buoyancy_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	soy_fields_buoyancy_set_density (self, (gfloat) 0);
	return obj;
}
...
static void soy_fields_buoyancy_class_init (soyfieldsBuoyancyClass * klass) {
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), SOY_FIELDS_BUOYANCY_DENSITY, g_param_spec_float ("density", "density", "density", -G_MAXFLOAT, G_MAXFLOAT, 0.0F, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE));
}
...
static void _vala_soy_fields_buoyancy_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec) {
	...
	switch (property_id) {
		case SOY_FIELDS_BUOYANCY_DENSITY:
		g_value_set_float (value, soy_fields_buoyancy_get_density (self));
		break;
		default:
...
static void _vala_soy_fields_buoyancy_set_property (GObject * object, guint property_id, const GValue * value, GParamSpec * pspec) {
	...
	switch (property_id) {
		case SOY_FIELDS_BUOYANCY_DENSITY:
		soy_fields_buoyancy_set_density (self, g_value_get_float (value));
		break;
		default:
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
		break;
