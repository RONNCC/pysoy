/* TDSide.c generated by valac 0.18.1, the Vala compiler
...
void soy_scenes_td_side_set2d (soyscenesTDSide* self, soybodiesBody* body) {
	...
	_tmp3_ = body;
	_tmp4_ = body;
	_tmp5_ = soy_joints_plane2_d_new ((soyscenesScene*) self, _tmp4_, NULL, NULL);
	_tmp6_ = _tmp5_;
...
void soy_scenes_td_side_unset2d (soyscenesTDSide* self, soybodiesBody* body) {
	...
	_tmp2_ = self->plane2ds;
	_tmp3_ = body;
	_tmp4_ = soy_joints_plane2_d_new (NULL, NULL, NULL, NULL);
	_tmp5_ = _tmp4_;
