/* KeyPress.c generated by valac 0.18.1, the Vala compiler
...
static void _vala_soy_events_key_press_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec);
...
soyeventsKeyPress* soy_events_key_press_new (void) {
	return soy_events_key_press_construct (SOY_EVENTS_TYPE_KEY_PRESS);
}
...
static void soy_events_key_press_class_init (soyeventsKeyPressClass * klass) {
	...
	G_OBJECT_CLASS (klass)->get_property = _vala_soy_events_key_press_get_property;
	g_object_class_install_property (G_OBJECT_CLASS (klass), SOY_EVENTS_KEY_PRESS_KEY, g_param_spec_int ("key", "key", "key", G_MININT, G_MAXINT, 0, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
}
...
static void _vala_soy_events_key_press_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec) {
	...
	self = G_TYPE_CHECK_INSTANCE_CAST (object, SOY_EVENTS_TYPE_KEY_PRESS, soyeventsKeyPress);
	switch (property_id) {
		case SOY_EVENTS_KEY_PRESS_KEY:
		g_value_set_int (value, soy_events_key_press_get_key (self));
		break;
		default:
