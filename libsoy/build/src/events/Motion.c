/* Motion.c generated by valac 0.18.1, the Vala compiler
...
soyeventsMotion* soy_events_motion_dup (const soyeventsMotion* self) {
	soyeventsMotion* dup;
	dup = g_new0 (soyeventsMotion, 1);
	soy_events_motion_copy (self, dup);
	return dup;
}


void soy_events_motion_free (soyeventsMotion* self) {
	soy_events_motion_destroy (self);
	g_free (self);
}
...
GType soy_events_motion_get_type (void) {
	...
	if (g_once_init_enter (&soy_events_motion_type_id__volatile)) {
		...
		soy_events_motion_type_id = g_boxed_type_register_static ("soyeventsMotion", (GBoxedCopyFunc) soy_events_motion_dup, (GBoxedFreeFunc) soy_events_motion_free);
