/* ButtonRelease.c generated by valac 0.18.1, the Vala compiler
...
enum  {
	...
	SOY_EVENTS_BUTTON_RELEASE_BUTTON
};
...
static void _vala_soy_events_button_release_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec);
...
soyeventsButtonRelease* soy_events_button_release_new (void) {
	return soy_events_button_release_construct (SOY_EVENTS_TYPE_BUTTON_RELEASE);
}
...
static void soy_events_button_release_class_init (soyeventsButtonReleaseClass * klass) {
	...
	G_OBJECT_CLASS (klass)->get_property = _vala_soy_events_button_release_get_property;
	g_object_class_install_property (G_OBJECT_CLASS (klass), SOY_EVENTS_BUTTON_RELEASE_BUTTON, g_param_spec_int ("button", "button", "button", G_MININT, G_MAXINT, 0, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
}
...
static void _vala_soy_events_button_release_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec) {
	...
	self = G_TYPE_CHECK_INSTANCE_CAST (object, SOY_EVENTS_TYPE_BUTTON_RELEASE, soyeventsButtonRelease);
	switch (property_id) {
		case SOY_EVENTS_BUTTON_RELEASE_BUTTON:
		g_value_set_int (value, soy_events_button_release_get_button (self));
		break;
		default:
