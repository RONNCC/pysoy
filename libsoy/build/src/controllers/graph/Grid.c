/* Grid.c generated by valac 0.18.1, the Vala compiler
...
static soycontrollersgraph_gridOffsetPair** _vala_array_dup1 (soycontrollersgraph_gridOffsetPair** self, int length);
