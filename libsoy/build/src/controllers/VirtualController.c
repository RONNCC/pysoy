/* VirtualController.c generated by valac 0.18.1, the Vala compiler
...
soycontrollersVirtualController* soy_controllers_virtual_controller_construct (GType object_type, soyscenesScene* scene) {
	...
	_tmp3_ = scene;
	_tmp4_ = _tmp3_->Controllers;
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp4_, self);
	_tmp5_ = scene;
	g_rw_lock_writer_unlock (&_tmp5_->stepLock);
	return self;
}
