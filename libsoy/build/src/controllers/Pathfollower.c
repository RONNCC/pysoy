/* Pathfollower.c generated by valac 0.18.1, the Vala compiler
...
static void soy_controllers_pathfollower_real_unregister_controller (soycontrollersVirtualController* base) {
	...
	_tmp1_ = self->controlled;
	_tmp2_ = _tmp1_->body;
	soy_controllers_pathfollower_path_finished (self, _tmp2_);
	_tmp3_ = ((soycontrollersVirtualController*) self)->scene;
	g_rw_lock_writer_unlock (&_tmp3_->stepLock);
}
