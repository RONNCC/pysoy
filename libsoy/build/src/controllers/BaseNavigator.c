/* BaseNavigator.c generated by valac 0.18.1, the Vala compiler
...
static void _soy_controllers_base_navigator_set_cat_bits (soycontrollersBaseNavigator* self, gulong bts) {
	...
	g_return_if_fail (self != NULL);
	_tmp0_ = ((soycontrollersVirtualController*) self)->scene;
	g_rw_lock_writer_lock (&_tmp0_->stepLock);
	_tmp1_ = ((soycontrollersPathfollower*) self)->controlled;
	_tmp2_ = _tmp1_->geom;
	if (_tmp2_ != NULL) {
		...
		_tmp4_ = _tmp3_->geom;
		_tmp5_ = bts;
		dGeomSetCategoryBits (_tmp4_, _tmp5_);
	}
	_tmp6_ = ((soycontrollersVirtualController*) self)->scene;
