/* Material.c generated by valac 0.18.1, the Vala compiler
...
static gboolean soy_materials_material_real_render (soymaterialsMaterial* self, gint pass, GLvoid* tslvs);
...
gboolean soy_materials_material_render (soymaterialsMaterial* self, gint pass, GLvoid* tslvs) {
	...
	return SOY_MATERIALS_MATERIAL_GET_CLASS (self)->render (self, pass, tslvs);
}
