/* Client.c generated by valac 0.18.1, the Vala compiler
...
void soy_net_client_cube (soynetClient* self, gint pos) {
	...
	soyatomsSize* _tmp3_;
	soyatomsSize* _tmp4_;
	soymaterialsColored* _tmp5_;
	soymaterialsColored* _tmp6_;
	soybodiesBox* _tmp7_;
	soybodiesBox* _tmp8_;
	soybodiesBox* box;
	g_return_if_fail (self != NULL);
	_tmp0_ = pos;
	_tmp1_ = soy_atoms_position_new ((gfloat) _tmp0_, (gfloat) 0, (gfloat) 0);
	_tmp2_ = _tmp1_;
	_tmp3_ = soy_atoms_size_new ((gfloat) 1, (gfloat) 1, (gfloat) 1);
	_tmp4_ = _tmp3_;
	_tmp5_ = soy_materials_colored_new (NULL);
	_tmp6_ = _tmp5_;
	_tmp7_ = soy_bodies_box_new (_tmp2_, _tmp4_, (soymaterialsMaterial*) _tmp6_);
	_tmp8_ = _tmp7_;
