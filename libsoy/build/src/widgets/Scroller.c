/* Scroller.c generated by valac 0.18.1, the Vala compiler
...
soywidgetsScroller* soy_widgets_scroller_construct (GType object_type, soywidgetsContainer* parent) {
	...
	_tmp0_ = parent;
	self = (soywidgetsScroller*) soy_widgets_container_construct (object_type, _tmp0_);
	_tmp1_ = parent;
...
soywidgetsScroller* soy_widgets_scroller_new (soywidgetsContainer* parent) {
	return soy_widgets_scroller_construct (SOY_WIDGETS_TYPE_SCROLLER, parent);
}
