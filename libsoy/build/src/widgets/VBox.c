/* VBox.c generated by valac 0.18.1, the Vala compiler
...
soywidgetsVBox* soy_widgets_vbox_construct (GType object_type, soywidgetsContainer* parent) {
	...
	soyatomsSize* _tmp4_;
	_tmp0_ = parent;
	self = (soywidgetsVBox*) soy_widgets_container_construct (object_type, _tmp0_);
	_tmp1_ = parent;
	_tmp2_ = soy_widgets_widget_get_size ((soywidgetsWidget*) _tmp1_);
	_tmp3_ = _tmp2_;
	_tmp4_ = _tmp3_;
	soy_widgets_widget_set_size ((soywidgetsWidget*) self, _tmp4_);
...
soywidgetsVBox* soy_widgets_vbox_new (soywidgetsContainer* parent) {
	return soy_widgets_vbox_construct (SOY_WIDGETS_TYPE_VBOX, parent);
}
