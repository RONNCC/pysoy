/* HBox.c generated by valac 0.18.1, the Vala compiler
...
soywidgetsHBox* soy_widgets_hbox_construct (GType object_type, soywidgetsContainer* parent) {
	...
	soyatomsSize* _tmp4_;
	_tmp0_ = parent;
	self = (soywidgetsHBox*) soy_widgets_container_construct (object_type, _tmp0_);
	_tmp1_ = parent;
...
soywidgetsHBox* soy_widgets_hbox_new (soywidgetsContainer* parent) {
	return soy_widgets_hbox_construct (SOY_WIDGETS_TYPE_HBOX, parent);
}
