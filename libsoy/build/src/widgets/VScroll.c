/* VScroll.c generated by valac 0.18.1, the Vala compiler
...
soywidgetsVScroll* soy_widgets_vscroll_construct (GType object_type, soywidgetsContainer* parent) {
	...
	_tmp0_ = parent;
	self = (soywidgetsVScroll*) soy_widgets_scroller_construct (object_type, _tmp0_);
...
soywidgetsVScroll* soy_widgets_vscroll_new (soywidgetsContainer* parent) {
	return soy_widgets_vscroll_construct (SOY_WIDGETS_TYPE_VSCROLL, parent);
}
