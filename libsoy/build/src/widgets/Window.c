...
soywidgetsWindow* soy_widgets_window_construct (GType object_type, soywidgetsContainer* parent) {
	...
	GLfloat* _tmp2_ = NULL;
	_tmp0_ = parent;
	self = (soywidgetsWindow*) soy_widgets_container_construct (object_type, _tmp0_);
	_tmp1_ = g_strdup ("");
	_g_free0 (self->priv->_title);
	self->priv->_title = _tmp1_;
	_tmp2_ = g_new0 (GLfloat, 4);
	_tmp2_[0] = (GLfloat) 0.0f;
	_tmp2_[1] = (GLfloat) 0.0f;
	_tmp2_[2] = (GLfloat) 0.0f;
...
soywidgetsWindow* soy_widgets_window_new (soywidgetsContainer* parent) {
	return soy_widgets_window_construct (SOY_WIDGETS_TYPE_WINDOW, parent);
}
