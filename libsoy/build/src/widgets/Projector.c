/* Projector.c generated by valac 0.18.1, the Vala compiler
...
soywidgetsProjector* soy_widgets_projector_construct (GType object_type, soywidgetsContainer* parent, soybodiesCamera* camera) {
	...
	soybodiesCamera* _tmp2_;
	soywidgetsContainer* _tmp3_;
	soyatomsSize* _tmp4_;
	soyatomsSize* _tmp5_;
	soyatomsSize* _tmp6_;
	_tmp0_ = parent;
	self = (soywidgetsProjector*) soy_widgets_widget_construct (object_type, _tmp0_);
	_tmp1_ = camera;
	_tmp2_ = _g_object_ref0 (_tmp1_);
	_g_object_unref0 (self->priv->_camera);
	self->priv->_camera = _tmp2_;
	_tmp3_ = parent;
	_tmp4_ = soy_widgets_widget_get_size ((soywidgetsWidget*) _tmp3_);
	_tmp5_ = _tmp4_;
	_tmp6_ = _tmp5_;
	soy_widgets_widget_set_size ((soywidgetsWidget*) self, _tmp6_);
...
soywidgetsProjector* soy_widgets_projector_new (soywidgetsContainer* parent, soybodiesCamera* camera) {
	return soy_widgets_projector_construct (SOY_WIDGETS_TYPE_PROJECTOR, parent, camera);
}
