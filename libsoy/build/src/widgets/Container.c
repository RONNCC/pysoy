/* Container.c generated by valac 0.18.1, the Vala compiler
...
soywidgetsContainer* soy_widgets_container_construct (GType object_type, soywidgetsContainer* parent) {
	...
	_tmp0_ = parent;
	self = (soywidgetsContainer*) soy_widgets_widget_construct (object_type, _tmp0_);
	_tmp1_ = gee_linked_list_new (SOY_WIDGETS_TYPE_WIDGET, (GBoxedCopyFunc) g_object_ref, g_object_unref, NULL);
...
soywidgetsContainer* soy_widgets_container_new (soywidgetsContainer* parent) {
	return soy_widgets_container_construct (SOY_WIDGETS_TYPE_CONTAINER, parent);
}
