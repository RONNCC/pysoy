/* soy.h generated by valac 0.18.1, the Vala compiler, do not modify */
...
gfloat soy_fields_buoyancy_get_density (soyfieldsBuoyancy* self);
void soy_fields_buoyancy_set_density (soyfieldsBuoyancy* self, gfloat value);
...
soyjointsBall* soy_joints_ball_new (soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soymaterialsMaterial* material);
soyjointsBall* soy_joints_ball_construct (GType object_type, soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soymaterialsMaterial* material);
...
soyjointsHinge2* soy_joints_hinge2_new (soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soyatomsAxis* axis1, soyatomsAxis* axis2, soymaterialsMaterial* material);
soyjointsHinge2* soy_joints_hinge2_construct (GType object_type, soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soyatomsAxis* axis1, soyatomsAxis* axis2, soymaterialsMaterial* material);
...
soyjointsPiston* soy_joints_piston_new (soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soyatomsAxis* axis1, soyatomsAxis* axis2, soymaterialsMaterial* material);
soyjointsPiston* soy_joints_piston_construct (GType object_type, soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soyatomsAxis* axis1, soyatomsAxis* axis2, soymaterialsMaterial* material);
...
soyjointsUniversal* soy_joints_universal_new (soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soyatomsAxis* axis1, soyatomsAxis* axis2, soymaterialsMaterial* material);
...
soywidgetsCanvas* soy_widgets_canvas_new (soywidgetsContainer* parent, soytexturesTexture* texture);
soywidgetsCanvas* soy_widgets_canvas_construct (GType object_type, soywidgetsContainer* parent, soytexturesTexture* texture);
...
soywidgetsHBox* soy_widgets_hbox_new (soywidgetsContainer* parent);
soywidgetsHBox* soy_widgets_hbox_construct (GType object_type, soywidgetsContainer* parent);
GType soy_widgets_scroller_get_type (void) G_GNUC_CONST;
GType soy_widgets_hscroll_get_type (void) G_GNUC_CONST;
soywidgetsHScroll* soy_widgets_hscroll_new (soywidgetsContainer* parent);
...
soywidgetsProjector* soy_widgets_projector_new (soywidgetsContainer* parent, soybodiesCamera* camera);
soywidgetsProjector* soy_widgets_projector_construct (GType object_type, soywidgetsContainer* parent, soybodiesCamera* camera);
...
soywidgetsScroller* soy_widgets_scroller_new (soywidgetsContainer* parent);
soywidgetsScroller* soy_widgets_scroller_construct (GType object_type, soywidgetsContainer* parent);
...
soywidgetsVBox* soy_widgets_vbox_new (soywidgetsContainer* parent);
soywidgetsVBox* soy_widgets_vbox_construct (GType object_type, soywidgetsContainer* parent);
GType soy_widgets_vscroll_get_type (void) G_GNUC_CONST;
soywidgetsVScroll* soy_widgets_vscroll_new (soywidgetsContainer* parent);
soywidgetsVScroll* soy_widgets_vscroll_construct (GType object_type, soywidgetsContainer* parent);
soywidgetsWidget* soy_widgets_widget_new (soywidgetsContainer* parent);
soywidgetsWidget* soy_widgets_widget_construct (GType object_type, soywidgetsContainer* parent);
...
soywidgetsWindow* soy_widgets_window_new (soywidgetsContainer* parent);
soywidgetsWindow* soy_widgets_window_construct (GType object_type, soywidgetsContainer* parent);
