...
soyjointsJoint* soy_joints_joint_construct (GType object_type, soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soyatomsAxis* axis1, soyatomsAxis* axis2, soymaterialsMaterial* material) {
	...
	GLfloat _tmp109_;
	soymaterialsMaterial* _tmp110_;
	soyscenesScene* _tmp115_;
	struct dxJoint* _tmp116_;
	soybodiesBody* _tmp117_;
	soyatomsPosition* _tmp126_;
	soyatomsAxis* _tmp127_;
	soyatomsAxis* _tmp128_;
	soyscenesScene* _tmp129_;
	GeeArrayList* _tmp130_;
	soyscenesScene* _tmp131_;
	...
	_tmp5_ = bodyA;
	_tmp6_ = _tmp5_->body;
	_tmp7_ = dBodyGetPosition (_tmp6_);
	posA = _tmp7_;
	_tmp8_ = bodyB;
	_tmp9_ = _tmp8_->body;
	...
	_tmp17_ = posA;
	_tmp18_ = _tmp17_->x;
	_tmp19_ = atan2 ((gdouble) (_tmp12_ - _tmp14_), (gdouble) (_tmp16_ - _tmp18_));
	thetaXY = (dReal) _tmp19_;
	_tmp20_ = posB;
	_tmp21_ = _tmp20_->z;
	_tmp22_ = posA;
	_tmp23_ = _tmp22_->z;
	...
	_tmp26_ = posA;
	_tmp27_ = _tmp26_->y;
	_tmp28_ = atan2 ((gdouble) (_tmp21_ - _tmp23_), (gdouble) (_tmp25_ - _tmp27_));
	thetaYZ = (dReal) _tmp28_;
	_tmp29_ = posB;
	_tmp30_ = _tmp29_->z;
	_tmp31_ = posA;
	_tmp32_ = _tmp31_->z;
	...
	_tmp35_ = posA;
	_tmp36_ = _tmp35_->x;
	_tmp37_ = atan2 ((gdouble) (_tmp30_ - _tmp32_), (gdouble) (_tmp34_ - _tmp36_));
	thetaXZ = (dReal) _tmp37_;
	_tmp38_ = rotation;
	_tmp39_ = thetaYZ;
	_tmp40_ = thetaXZ;
	_tmp41_ = thetaXY;
	dRFromEulerAngles (_tmp38_, _tmp39_, _tmp40_, _tmp41_);
	_tmp42_ = self->priv->_jointMtx;
	_tmp42__length1 = self->priv->_jointMtx_length1;
	_tmp43_ = rotation;
	_tmp44_ = _tmp43_->m0;
	_tmp42_[0] = (GLfloat) _tmp44_;
	_tmp45_ = _tmp42_[0];
	_tmp46_ = self->priv->_jointMtx;
	_tmp46__length1 = self->priv->_jointMtx_length1;
	_tmp47_ = rotation;
	_tmp48_ = _tmp47_->m4;
	_tmp46_[1] = (GLfloat) _tmp48_;
	_tmp49_ = _tmp46_[1];
	_tmp50_ = self->priv->_jointMtx;
	_tmp50__length1 = self->priv->_jointMtx_length1;
	_tmp51_ = rotation;
	_tmp52_ = _tmp51_->m8;
	_tmp50_[2] = (GLfloat) _tmp52_;
	_tmp53_ = _tmp50_[2];
	_tmp54_ = self->priv->_jointMtx;
	_tmp54__length1 = self->priv->_jointMtx_length1;
	_tmp54_[3] = (GLfloat) 0.0;
	_tmp55_ = _tmp54_[3];
	_tmp56_ = self->priv->_jointMtx;
	_tmp56__length1 = self->priv->_jointMtx_length1;
	_tmp57_ = rotation;
	_tmp58_ = _tmp57_->m1;
	_tmp56_[4] = (GLfloat) _tmp58_;
	_tmp59_ = _tmp56_[4];
	_tmp60_ = self->priv->_jointMtx;
	_tmp60__length1 = self->priv->_jointMtx_length1;
	_tmp61_ = rotation;
	_tmp62_ = _tmp61_->m5;
	_tmp60_[5] = (GLfloat) _tmp62_;
	_tmp63_ = _tmp60_[5];
	_tmp64_ = self->priv->_jointMtx;
	_tmp64__length1 = self->priv->_jointMtx_length1;
	_tmp65_ = rotation;
	_tmp66_ = _tmp65_->m9;
	_tmp64_[6] = (GLfloat) _tmp66_;
	_tmp67_ = _tmp64_[6];
	_tmp68_ = self->priv->_jointMtx;
	_tmp68__length1 = self->priv->_jointMtx_length1;
	_tmp68_[7] = (GLfloat) 0.0;
	_tmp69_ = _tmp68_[7];
	_tmp70_ = self->priv->_jointMtx;
	_tmp70__length1 = self->priv->_jointMtx_length1;
	_tmp71_ = rotation;
	_tmp72_ = _tmp71_->m2;
	_tmp70_[8] = (GLfloat) _tmp72_;
	_tmp73_ = _tmp70_[8];
	_tmp74_ = self->priv->_jointMtx;
	_tmp74__length1 = self->priv->_jointMtx_length1;
	_tmp75_ = rotation;
	_tmp76_ = _tmp75_->m6;
	_tmp74_[9] = (GLfloat) _tmp76_;
	_tmp77_ = _tmp74_[9];
	_tmp78_ = self->priv->_jointMtx;
	_tmp78__length1 = self->priv->_jointMtx_length1;
	_tmp79_ = rotation;
	_tmp80_ = _tmp79_->ma;
	_tmp78_[10] = (GLfloat) _tmp80_;
	_tmp81_ = _tmp78_[10];
	_tmp82_ = self->priv->_jointMtx;
	_tmp82__length1 = self->priv->_jointMtx_length1;
	_tmp82_[11] = (GLfloat) 0.0;
	_tmp83_ = _tmp82_[11];
	_tmp84_ = self->priv->_jointMtx;
	_tmp84__length1 = self->priv->_jointMtx_length1;
	_tmp85_ = posA;
	_tmp86_ = _tmp85_->x;
	_tmp87_ = posB;
	_tmp88_ = _tmp87_->x;
	_tmp89_ = posA;
	_tmp90_ = _tmp89_->x;
	_tmp84_[12] = (GLfloat) (((_tmp86_ + _tmp88_) / 2) - _tmp90_);
	_tmp91_ = _tmp84_[12];
	_tmp92_ = self->priv->_jointMtx;
	_tmp92__length1 = self->priv->_jointMtx_length1;
	_tmp93_ = posA;
	_tmp94_ = _tmp93_->y;
	_tmp95_ = posB;
	_tmp96_ = _tmp95_->y;
	_tmp97_ = posA;
	_tmp98_ = _tmp97_->y;
	_tmp92_[13] = (GLfloat) (((_tmp94_ + _tmp96_) / 2) - _tmp98_);
	_tmp99_ = _tmp92_[13];
	_tmp100_ = self->priv->_jointMtx;
	_tmp100__length1 = self->priv->_jointMtx_length1;
	_tmp101_ = posA;
	_tmp102_ = _tmp101_->z;
	_tmp103_ = posB;
	_tmp104_ = _tmp103_->z;
	_tmp105_ = posA;
	_tmp106_ = _tmp105_->z;
	_tmp100_[14] = (GLfloat) (((_tmp102_ + _tmp104_) / 2) - _tmp106_);
	_tmp107_ = _tmp100_[14];
	_tmp108_ = self->priv->_jointMtx;
	_tmp108__length1 = self->priv->_jointMtx_length1;
	_tmp108_[15] = (GLfloat) 1.0;
	_tmp109_ = _tmp108_[15];
	g_mutex_unlock (&self->mutex);
	_tmp110_ = material;
	if (_tmp110_ == NULL) {
		soymaterialsMaterial* _tmp111_;
		soymaterialsMaterial* _tmp113_;
		_tmp111_ = soy_default_material;
		if (_tmp111_ == NULL) {
			soymaterialsMaterial* _tmp112_;
			_tmp112_ = soy_materials_material_new ();
			_g_object_unref0 (soy_default_material);
			soy_default_material = _tmp112_;
		}
		_tmp113_ = soy_default_material;
		soy_joints_joint_set_material (self, _tmp113_);
	} else {
		soymaterialsMaterial* _tmp114_;
		_tmp114_ = material;
		soy_joints_joint_set_material (self, _tmp114_);
	}
	_tmp115_ = scene;
	g_rw_lock_writer_lock (&_tmp115_->stepLock);
	soy_joints_joint_create (self);
	_tmp116_ = self->joint;
	dJointSetData (_tmp116_, (void*) self);
	_tmp117_ = bodyB;
	if (_tmp117_ == NULL) {
		struct dxJoint* _tmp118_;
		soybodiesBody* _tmp119_;
		struct dxBody* _tmp120_;
		_tmp118_ = self->joint;
		_tmp119_ = bodyA;
		_tmp120_ = _tmp119_->body;
		dJointAttach (_tmp118_, _tmp120_, NULL);
	} else {
		struct dxJoint* _tmp121_;
		soybodiesBody* _tmp122_;
		struct dxBody* _tmp123_;
		soybodiesBody* _tmp124_;
		struct dxBody* _tmp125_;
		_tmp121_ = self->joint;
		_tmp122_ = bodyA;
		_tmp123_ = _tmp122_->body;
		_tmp124_ = bodyB;
		_tmp125_ = _tmp124_->body;
		dJointAttach (_tmp121_, _tmp123_, _tmp125_);
	}
	_tmp126_ = anchor;
	_tmp127_ = axis1;
	_tmp128_ = axis2;
	soy_joints_joint_setup (self, _tmp126_, _tmp127_, _tmp128_);
	_tmp129_ = scene;
	_tmp130_ = _tmp129_->joints;
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp130_, self);
	_tmp131_ = scene;
	g_rw_lock_writer_unlock (&_tmp131_->stepLock);
	_dmatrix3_free0 (rotation);
	return self;
}
...
static void soy_joints_joint_real_mult_model_matrix (soyjointsJoint* self) {
	...
	_tmp1_ = self->bodyA;
	_tmp2_ = _tmp1_->body;
	_tmp3_ = dBodyGetPosition (_tmp2_);
	posA = _tmp3_;
	_tmp4_ = self->bodyB;
	_tmp5_ = _tmp4_->body;
	...
	_tmp7_ = self->bodyA;
	_tmp8_ = _tmp7_->body;
	_tmp9_ = dBodyGetRotation (_tmp8_);
	rotationA = _tmp9_;
	_tmp10_ = rotationA->m0;
	_mtx[0] = (GLfloat) _tmp10_;
	_tmp11_ = _mtx[0];
	_tmp12_ = rotationA->m4;
	_mtx[1] = (GLfloat) _tmp12_;
	_tmp13_ = _mtx[1];
	_tmp14_ = rotationA->m8;
	_mtx[2] = (GLfloat) _tmp14_;
	_tmp15_ = _mtx[2];
	_mtx[3] = (GLfloat) 0.0;
	_tmp16_ = _mtx[3];
	_tmp17_ = rotationA->m1;
	_mtx[4] = (GLfloat) _tmp17_;
	_tmp18_ = _mtx[4];
	_tmp19_ = rotationA->m5;
	_mtx[5] = (GLfloat) _tmp19_;
	_tmp20_ = _mtx[5];
	_tmp21_ = rotationA->m9;
	_mtx[6] = (GLfloat) _tmp21_;
	_tmp22_ = _mtx[6];
	_mtx[7] = (GLfloat) 0.0;
	_tmp23_ = _mtx[7];
	_tmp24_ = rotationA->m2;
	_mtx[8] = (GLfloat) _tmp24_;
	_tmp25_ = _mtx[8];
	_tmp26_ = rotationA->m6;
	_mtx[9] = (GLfloat) _tmp26_;
	_tmp27_ = _mtx[9];
	_tmp28_ = rotationA->ma;
	_mtx[10] = (GLfloat) _tmp28_;
	_tmp29_ = _mtx[10];
	_mtx[11] = (GLfloat) 0.0;
	_tmp30_ = _mtx[11];
	_tmp31_ = posA->x;
	_mtx[12] = (GLfloat) _tmp31_;
	_tmp32_ = _mtx[12];
	_tmp33_ = posA->y;
	_mtx[13] = (GLfloat) _tmp33_;
	_tmp34_ = _mtx[13];
	_tmp35_ = posA->z;
	_mtx[14] = (GLfloat) _tmp35_;
	_tmp36_ = _mtx[14];
	_mtx[15] = (GLfloat) 1.0;
	_tmp37_ = _mtx[15];
	glMultMatrixf (_mtx);
	_tmp38_ = self->priv->_jointMtx;
	_tmp38__length1 = self->priv->_jointMtx_length1;
	glMultMatrixf (_tmp38_);
