/* Hinge2.c generated by valac 0.18.1, the Vala compiler
...
soyjointsHinge2* soy_joints_hinge2_construct (GType object_type, soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soyatomsAxis* axis1, soyatomsAxis* axis2, soymaterialsMaterial* material) {
	...
	_tmp5_ = axis2;
	_tmp6_ = material;
	self = (soyjointsHinge2*) soy_joints_joint_construct (object_type, _tmp0_, _tmp1_, _tmp2_, _tmp3_, _tmp4_, _tmp5_, _tmp6_);
	return self;
}


soyjointsHinge2* soy_joints_hinge2_new (soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soyatomsAxis* axis1, soyatomsAxis* axis2, soymaterialsMaterial* material) {
	return soy_joints_hinge2_construct (SOY_JOINTS_TYPE_HINGE2, scene, bodyA, bodyB, anchor, axis1, axis2, material);
}
...
static void soy_joints_hinge2_real_create (soyjointsJoint* base) {
	...
	_tmp1_ = _tmp0_->world;
	_tmp2_ = dJointCreateHinge2 (_tmp1_, NULL);
...
static void _soy_joints_hinge2_anchor_set (soyjointsHinge2* self, soyatomsPosition* anchor) {
	...
	_tmp10_ = _tmp9_;
	dJointSetHinge2Anchor ((struct dxJoint*) _tmp1_, (dReal) _tmp4_, (dReal) _tmp7_, (dReal) _tmp10_);
...
static void _soy_joints_hinge2_axis1_set (soyjointsHinge2* self, soyatomsAxis* value) {
	...
	_tmp9_ = _tmp8_;
	dJointSetHinge2Axis1 ((struct dxJoint*) _tmp3_, (dReal) _tmp5_, (dReal) _tmp7_, (dReal) _tmp9_);
...
static void _soy_joints_hinge2_axis2_set (soyjointsHinge2* self, soyatomsAxis* value) {
	...
	_tmp9_ = _tmp8_;
	dJointSetHinge2Axis2 ((struct dxJoint*) _tmp3_, (dReal) _tmp5_, (dReal) _tmp7_, (dReal) _tmp9_);
	_tmp10_ = ((soyjointsJoint*) self)->scene;
	g_rw_lock_writer_unlock (&_tmp10_->stepLock);
