/* Ball.c generated by valac 0.18.1, the Vala compiler
...
soyjointsBall* soy_joints_ball_construct (GType object_type, soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soymaterialsMaterial* material) {
	...
	_tmp3_ = anchor;
	_tmp4_ = material;
	self = (soyjointsBall*) soy_joints_joint_construct (object_type, _tmp0_, _tmp1_, _tmp2_, _tmp3_, NULL, NULL, _tmp4_);
	return self;
}


soyjointsBall* soy_joints_ball_new (soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soymaterialsMaterial* material) {
	return soy_joints_ball_construct (SOY_JOINTS_TYPE_BALL, scene, bodyA, bodyB, anchor, material);
}
...
static void soy_joints_ball_real_create (soyjointsJoint* base) {
	...
	_tmp1_ = _tmp0_->world;
	_tmp2_ = dJointCreateBall (_tmp1_, NULL);
...
static void _soy_joints_ball_anchor_set (soyjointsBall* self, soyatomsPosition* anchor) {
	...
	_tmp10_ = _tmp9_;
	dJointSetBallAnchor ((struct dxJoint*) _tmp1_, (dReal) _tmp4_, (dReal) _tmp7_, (dReal) _tmp10_);
