/* Piston.c generated by valac 0.18.1, the Vala compiler
...
soyjointsPiston* soy_joints_piston_construct (GType object_type, soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soyatomsAxis* axis1, soyatomsAxis* axis2, soymaterialsMaterial* material) {
	...
	_tmp5_ = axis2;
	_tmp6_ = material;
	self = (soyjointsPiston*) soy_joints_joint_construct (object_type, _tmp0_, _tmp1_, _tmp2_, _tmp3_, _tmp4_, _tmp5_, _tmp6_);
	return self;
}


soyjointsPiston* soy_joints_piston_new (soyscenesScene* scene, soybodiesBody* bodyA, soybodiesBody* bodyB, soyatomsPosition* anchor, soyatomsAxis* axis1, soyatomsAxis* axis2, soymaterialsMaterial* material) {
	return soy_joints_piston_construct (SOY_JOINTS_TYPE_PISTON, scene, bodyA, bodyB, anchor, axis1, axis2, material);
}
...
static void soy_joints_piston_real_create (soyjointsJoint* base) {
	...
	_tmp1_ = _tmp0_->world;
	_tmp2_ = dJointCreatePR (_tmp1_, NULL);
...
static void _soy_joints_piston_anchor_set (soyjointsPiston* self, soyatomsPosition* anchor) {
	...
	_tmp10_ = _tmp9_;
	dJointSetPRAnchor ((struct dxJoint*) _tmp1_, (dReal) _tmp4_, (dReal) _tmp7_, (dReal) _tmp10_);
...
static void _soy_joints_piston_axis1_set (soyjointsPiston* self, soyatomsAxis* value) {
	...
	_tmp9_ = _tmp8_;
	dJointSetPRAxis1 ((struct dxJoint*) _tmp3_, (dReal) _tmp5_, (dReal) _tmp7_, (dReal) _tmp9_);
...
static void _soy_joints_piston_axis2_set (soyjointsPiston* self, soyatomsAxis* value) {
	...
	_tmp9_ = _tmp8_;
	dJointSetPRAxis2 ((struct dxJoint*) _tmp3_, (dReal) _tmp5_, (dReal) _tmp7_, (dReal) _tmp9_);
	_tmp10_ = ((soyjointsJoint*) self)->scene;
	g_rw_lock_writer_unlock (&_tmp10_->stepLock);
