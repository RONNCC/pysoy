...
class soy.bodies.Light : soy.bodies.Body
    ...
    VERTICES : GLuint = 40 // not including center - TODO calculate number of vertices needed (>256)
    ...
    def override render ( )
        ...
        _texture.enable()
        glDrawElements(GL_TRIANGLE_FAN, (GLsizei) (VERTICES*3), GL_UNSIGNED_BYTE, (GLvoid*) 0)
        glActiveTexture(GL_TEXTURE0)
        glClientActiveTexture(GL_TEXTURE0)
    ...
    def _update_light()
        ...
        // bind elements
        glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, _ebo)
        glBufferData(GL_ELEMENT_ARRAY_BUFFER, (GLsizei) (3 * VERTICES * sizeof(GLubyte)),
                     elements, GL_STATIC_DRAW)

        // bind vertices
        glBindBuffer(GL_ARRAY_BUFFER, _vbo)
        glBufferData(GL_ARRAY_BUFFER, (GLsizei) (11 * (VERTICES+1) * sizeof(GLfloat)),
