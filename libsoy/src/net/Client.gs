...
class soy.net.Client : Object
    ...
    def create_window() : void
        ...
        // var pr = new soy.widgets.Projector(this.window, cam)
        for var i = 0 to 10
            cube(i)

        //box.addForce(0.01f, 1.01f, 0.01f)
        //box.addTorque(0.01f, 1.1f, 0.01f)


    def cube (pos : int)
        //Android.log_print(Android.LogPriority.VERBOSE, "sweetsoy", "Creating a cube!!");
        var box = new soy.bodies.Box(new soy.atoms.Position(pos, 0, 0),
