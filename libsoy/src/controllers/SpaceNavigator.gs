...
class soy.controllers.SpaceNavigator : soy.controllers.BaseNavigator
    ...
    construct (scene : soy.scenes.Scene, controlled : soy.bodies.Body, speed : float, fuzziness : float, granularity : float, end : soy.atoms.Position, updates : bool, paused : bool)
        with_graph(scene, controlled, speed, fuzziness, new soy.controllers.graph.Space(scene, granularity), end, updates, paused)
