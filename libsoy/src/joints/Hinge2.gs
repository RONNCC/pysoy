...
class soy.joints.Hinge2: soy.joints.Joint
    construct(scene : soy.scenes.Scene, bodyA : soy.bodies.Body,
        ...
        super(scene, bodyA, bodyB, anchor, axis1, axis2, material)


    def override create ( )
        joint = new ode.joints.Hinge2(scene.world, null)


    def override setup (anchor : soy.atoms.Position?, axis1 : soy.atoms.Axis?,
                        axis2 : soy.atoms.Axis?)
        ((ode.joints.Hinge2) joint).SetAnchor((ode.Real) anchor.x,
                                              (ode.Real) anchor.y,
                                              (ode.Real) anchor.z)
        ((ode.joints.Hinge2) joint).SetAxis1((ode.Real) axis1.x,
                                             (ode.Real) axis1.y,
                                             (ode.Real) axis1.z)
        ((ode.joints.Hinge2) joint).SetAxis2((ode.Real) axis2.x,
                                             (ode.Real) axis2.y,
                                             (ode.Real) axis2.z)


    def addTorques(torque1 : ode.Real, torque2 : ode.Real)
        ((ode.joints.Hinge2) self.joint).AddTorques(torque1, torque2)
    ...
    def _anchor_set(anchor : soy.atoms.Position)
        ...
        ((ode.joints.Hinge2) self.joint).SetAnchor((ode.Real) anchor.x,
                                                   (ode.Real) anchor.y,
                                                   (ode.Real) anchor.z)
    ...
    prop anchor : soy.atoms.Position
        owned get
            ...
            ((ode.joints.Hinge2) self.joint).GetAnchor(v)
    ...
    def _axis1_set(value : soy.atoms.Axis)
        ...
        self.scene.stepLock.writer_lock()
        ((ode.joints.Hinge2) self.joint).SetAxis1((ode.Real) axis1.x,
                                                   (ode.Real) axis1.y,
                                                   (ode.Real) axis1.z)
        self.scene.stepLock.writer_unlock()
    ...
    prop axis1 : soy.atoms.Axis
        owned get
            v : ode.Vector3 = new ode.Vector3()
            ((ode.joints.Hinge2) self.joint).GetAxis1(v)
    ...
    def _axis2_set(value : soy.atoms.Axis)
        ...
        self.scene.stepLock.writer_lock()
        ((ode.joints.Hinge2) self.joint).SetAxis2((ode.Real) axis2.x,
                                                   (ode.Real) axis2.y,
                                                   (ode.Real) axis2.z)
        self.scene.stepLock.writer_unlock()
    ...
    prop axis2 : soy.atoms.Axis
        owned get
            v : ode.Vector3 = new ode.Vector3()
            ((ode.joints.Hinge2) self.joint).GetAxis2(v)
    ...
    prop readonly angle : float
        get
            return (float) ((ode.joints.Hinge2) self.joint).GetAngle1()
