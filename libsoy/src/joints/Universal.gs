...
class soy.joints.Universal: soy.joints.Joint
    ...
    def override create ( )
        joint = new ode.joints.Universal(scene.world, null)


    def override setup (anchor : soy.atoms.Position?, axis1 : soy.atoms.Axis?,
                        axis2 : soy.atoms.Axis?)
        ((ode.joints.Universal) joint).SetAnchor((ode.Real) anchor.x,
                                                 (ode.Real) anchor.y,
                                                 (ode.Real) anchor.z)
        ((ode.joints.Universal) joint).SetAxis1((ode.Real) axis1.x,
                                                (ode.Real) axis1.y,
                                                (ode.Real) axis1.z)
        ((ode.joints.Universal) joint).SetAxis2((ode.Real) axis2.x,
                                                (ode.Real) axis2.y,
                                                (ode.Real) axis2.z)


    def addTorques(torque1 : ode.Real, torque2 : ode.Real)
        ((ode.joints.Universal) self.joint).AddTorques(torque1, torque2)
    ...
    prop anchor : soy.atoms.Position
        owned get
            ...
            ((ode.joints.Universal) self.joint).GetAnchor(v)
    ...
    prop axis1 : soy.atoms.Axis
        owned get
            v : ode.Vector3 = new ode.Vector3()
            ((ode.joints.Universal) self.joint).GetAxis1(v)
    ...
    prop axis2 : soy.atoms.Axis
        owned get
            v : ode.Vector3 = new ode.Vector3()
            ((ode.joints.Universal) self.joint).GetAxis2(v)
    ...
    prop readonly angle : array of float
        owned get
            return {(float) ((ode.joints.Universal) self.joint).GetAngle1(),
                    (float) ((ode.joints.Universal) self.joint).GetAngle2()}
