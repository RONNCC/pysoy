...
class soy.scenes.TDSide : soy.scenes.Scene
    /*
        Class for a scene where movement of tdbodies is restricted onto a 2D plane.
    */
    ...
    def set2d(body : soy.bodies.Body)
        ...
        self.plane2ds[body] = new soy.joints.Plane2D(self, body, null, null)
    ...
    def unset2d(body : soy.bodies.Body)
        ...
        self.plane2ds[body] = new soy.joints.Plane2D(null, null, null, null)
